	...
	<div class="main-section clear" >
		...
		<?php
			...
			if(($_SERVER['REQUEST_METHOD']=="POST") && isset($_FILES['profile_pic'])){
				...
				if(empty($id) or empty($name) or empty($prog) or empty($pass) or empty($dob) or empty($gender) or empty($email) or empty($phone) or empty($permanent_add) or empty($father_n) or empty($contact)){
